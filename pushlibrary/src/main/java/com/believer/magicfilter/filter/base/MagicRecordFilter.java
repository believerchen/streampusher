...
import com.believer.magicfilter.beautify.MagicJni;
import com.believer.magicfilter.camera.RecordHelper;
...
public class MagicRecordFilter extends GPUImageFilter {
    ...
    private long mLastTimestamp = 0;//图像时间戳，用于录制帧数判断
    ...
    private long start_time2 = 0;
    private long end_time2 = 0;
...
//        long start_time2 = System.currentTimeMillis();
        ...
        //GLES20.glReadPixels(0, 0, mRowStride / mPixelStride, mInputHeight, GLES30.GL_RGBA, GLES30.GL_UNSIGNED_BYTE,null);
...
//        Log.i("7777777","耗费时间为（ms）： "+(end_time2-start_time2));
        if (byteBuffer instanceof ByteBuffer) {
            byteBuf = (ByteBuffer)byteBuffer;
            mRecordHelper.onRecord(byteBuf, mInputWidth, mInputHeight, mPixelStride, mRowStride, mLastTimestamp);
        }
