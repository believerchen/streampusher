package com.believer.magicfilter.camera.base;
...
import com.believer.magicfilter.filter.helper.MagicFilterFactory;
import com.believer.magicfilter.filter.helper.MagicFilterType;
import com.believer.magicfilter.utils.OpenGlUtils;
import com.believer.magicfilter.utils.Rotation;
...
public abstract class BaseGlSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    protected abstract void setDefaultFilter();
