...
import com.believer.mypublisher.coremedia.iso.ChannelHelper;
import com.believer.mypublisher.coremedia.iso.boxes.Box;
import com.believer.mypublisher.coremedia.iso.boxes.ContainerBox;
import com.believer.mypublisher.googlecode.mp4parser.AbstractBox;
 ...
 * by the metadata (see {@link com.believer.mypublisher.coremedia.iso.boxes.SampleTableBox}).<br>
 ...
 * metadata refers to media data by its absolute offset within the file (see {@link com.believer.mypublisher.coremedia.iso.boxes.StaticChunkOffsetBox});
