 ...
 */
package com.believer.mypublisher.googlecode.mp4parser.authoring.builder;

import com.believer.mypublisher.coremedia.iso.BoxParser;
import com.believer.mypublisher.coremedia.iso.IsoFile;
import com.believer.mypublisher.coremedia.iso.IsoTypeWriter;
import com.believer.mypublisher.coremedia.iso.boxes.Box;
import com.believer.mypublisher.coremedia.iso.boxes.CompositionTimeToSample;
import com.believer.mypublisher.coremedia.iso.boxes.ContainerBox;
import com.believer.mypublisher.coremedia.iso.boxes.DataEntryUrlBox;
import com.believer.mypublisher.coremedia.iso.boxes.DataInformationBox;
import com.believer.mypublisher.coremedia.iso.boxes.DataReferenceBox;
import com.believer.mypublisher.coremedia.iso.boxes.FileTypeBox;
import com.believer.mypublisher.coremedia.iso.boxes.HandlerBox;
import com.believer.mypublisher.coremedia.iso.boxes.MediaBox;
import com.believer.mypublisher.coremedia.iso.boxes.MediaHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.MediaInformationBox;
import com.believer.mypublisher.coremedia.iso.boxes.MovieBox;
import com.believer.mypublisher.coremedia.iso.boxes.MovieHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.SampleDependencyTypeBox;
import com.believer.mypublisher.coremedia.iso.boxes.SampleTableBox;
import com.believer.mypublisher.coremedia.iso.boxes.StaticChunkOffsetBox;
import com.believer.mypublisher.coremedia.iso.boxes.TimeToSampleBox;
import com.believer.mypublisher.coremedia.iso.boxes.TrackBox;
import com.believer.mypublisher.coremedia.iso.boxes.TrackHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieExtendsBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieExtendsHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieFragmentBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieFragmentHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieFragmentRandomAccessBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.MovieFragmentRandomAccessOffsetBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.SampleFlags;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.TrackExtendsBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.TrackFragmentBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.TrackFragmentHeaderBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.TrackFragmentRandomAccessBox;
import com.believer.mypublisher.coremedia.iso.boxes.fragment.TrackRunBox;
import com.believer.mypublisher.googlecode.mp4parser.authoring.Movie;
import com.believer.mypublisher.googlecode.mp4parser.authoring.Track;
...
import static com.believer.mypublisher.googlecode.mp4parser.util.CastUtils.l2i;
...
public class FragmentedMp4Builder implements Mp4Builder {
     ...
     * <ul>
     * <li>{@link #createMvhd(com.believer.mypublisher.googlecode.mp4parser.authoring.Movie) mvhd}</li>
     * <li>{@link #createMvex(com.believer.mypublisher.googlecode.mp4parser.authoring.Movie)  mvex}</li>
     * <li>a {@link #createTrak(com.believer.mypublisher.googlecode.mp4parser.authoring.Track, com.believer.mypublisher.googlecode.mp4parser.authoring.Movie)  trak} for every track</li>
     * </ul>
     *
     * @param movie the concerned movie
     ...
     * isofile. Uses {@link #createTfra(com.believer.mypublisher.googlecode.mp4parser.authoring.Track, IsoFile)}
     ...
     * by calling {@link #createTrex(com.believer.mypublisher.googlecode.mp4parser.authoring.Movie, com.believer.mypublisher.googlecode.mp4parser.authoring.Track)}
